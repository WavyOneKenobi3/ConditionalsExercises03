...
if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking"){
    console.log("ENGINE FAILURE IMMINENT!");
} else if (fuelLevel === 5000 || fuelLevel < 5000 || engineTemperature > 2500){
      console.log("Check fuel level. Engines running hot.");
  } else if (fuelLevel > 20000 && engineTemperature === 2500 || engineTemperature < 2500){
        console.log("Full tank. Engines good.");
    } else if (fuelLevel > 10000 && engineTemperature === 2500 || engineTemperature < 2500) {
          console.log("Fuel level above 50%. Engines good.");
      } else if (fuelLevel > 5000 && engineTemperature === 2500 || engineTemperature < 2500){
            console.log("Fuel level above 25%. Engines good."); 
        } else {
              console.log("Fuel and engine status pending...");
            }
...
if (!commandOverride && fuel === "OK" && engine == "OK"){
  console("Shuttle is OK to launch ");
} else if (commandOverride){
    console.log("Shuttle launch regardless of fuel and engine status");
}
